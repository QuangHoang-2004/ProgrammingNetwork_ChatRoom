...
public class ServiceUser {
    ...
    public Model_Message register(Model_Register data) {
        ...
        try {
            ...
            if (r.first()) {
                ...
                message.setMessager("User Already Exists.");
            } else {
            ...
            e.printStackTrace();
            message.setAction(false);
            message.setMessager("Server Error");
        }
        return message;
    }
    ...
    public Model_User_Account login(Model_Login login) throws SQLException{
        ...
        if(r.first()){
            ...
            System.out.println("ServiceUser: ID: " + userID + " UserName: " + userName+ " Gender: " + gender + " Image: " + image);
